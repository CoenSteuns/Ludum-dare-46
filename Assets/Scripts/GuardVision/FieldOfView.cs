...
public class FieldOfView : MonoBehaviour {
    ...
    //Edit in the editor, used for the view area of the guard. Visualized in FieldOfViewEditor.cs
	public float viewRadius;
	[Range(0,360)]
	public float viewAngle;

	//Layermask for the target layer and obstacle layer.
	[SerializeField]private LayerMask targetMask;
	[SerializeField]private LayerMask obstacleMask;

	//List of targets inside of vision cone.
	[HideInInspector]
	public List<Transform> visibleTargets = new List<Transform>();

	//Specifics of the Vision Cone.
	[SerializeField]private float meshResolution;
	[SerializeField]private int edgeResolveIterations;
	[SerializeField]private float edgeDistanceThreshold;

	//The mesh that shows the range of vision.
	...
	void Start() {
		...
		StartCoroutine ("FindTargetsWithDelay", SpottedDelay);
	}
	...
	//Draws the vision cone in the Late Update.
	void LateUpdate() {
		DrawFieldOfView ();
	}

	//Searches for targets in vision radius and detects them.
	...
	//The drawing of the vision cone.
